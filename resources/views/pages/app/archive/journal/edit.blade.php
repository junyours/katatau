...
@section('content')
  <form method="POST" action="{{ route('admin.journal.update', $journal->id) }}" enctype="multipart/form-data"
    ...
    @csrf
    <h1 class="capitalize font-semibold">Volume {{ $journal->archive->volume }}, Issue {{ $journal->archive->issue }},
      {{ Carbon\Carbon::parse($journal->archive->from_month)->format('F Y') }} -
      {{ Carbon\Carbon::parse($journal->archive->to_month)->format('F Y') }}
    </h1>
    <h1 class="font-semibold text-xl">Edit Journal</h1>
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="pdf_path" type="file" value="{{ old('pdf_path') }}"
        ...
        name="pdf_path" accept="application/pdf" />
      @error('pdf_path')
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="title" type="text" value="{{ $journal->title }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
        name="title" required />
      @error('title')
        <small class="pl-0.5 text-red-500">{{ $message }}</small>
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="author" type="text" value="{{ $journal->author }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="doi" type="text" value="{{ $journal->doi }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
        name="doi" required />
      @error('doi')
        <small class="pl-0.5 text-red-500">{{ $message }}</small>
    ...
    <div x-data="{
          ...
          options = allOptions;
          // Pre-select country based on $journal->country
          selectedOption = allOptions.find(o => o.value === '{{ $journal->country }}');
          if(selectedOption) { $refs.hiddenTextField.value = selectedOption.value; }
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="page_number" type="text" value="{{ $journal->page_number }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
      ...
      <textarea id="abstract" name="abstract"
        ...
        rows="3">{{ $journal->abstract }}</textarea>
      @error('abstract')
        <small class="pl-0.5 text-red-500">{{ $message }}</small>
      @enderror
    </div>
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="keyword" type="text" value="{{ $journal->keyword }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
    ...
    <div class="flex w-full flex-col gap-1 text-neutral-600">
      ...
      <input id="publication_date" type="date" value="{{ $journal->publication_date }}"
        class="w-full rounded-sm border border-neutral-300 bg-neutral-50 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black disabled:cursor-not-allowed disabled:opacity-75"
