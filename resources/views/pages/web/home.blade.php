    ...
    <div class="space-y-4">
      ...
      @foreach ($journals as $journal)
        ...
        <div class="space-y-4 border-b border-slate-300 pb-4">
          <div class="space-y-2">
            ...
            <h4 class="font-semibold">Volume {{ $archive->volume }}, Issue {{ $archive->issue }},
      ...
      <div class="flex justify-end">
        <a href="{{ route('current-issue') }}">
          <button type="button"
            class="inline-flex justify-center items-center gap-2 whitespace-nowrap rounded-md border border-slate-800 px-4 py-2 text-xs font-medium tracking-wide transition hover:opacity-75 text-center focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-800 active:opacity-100 active:outline-offset-0 disabled:opacity-75 disabled:cursor-not-allowed">
            View More
